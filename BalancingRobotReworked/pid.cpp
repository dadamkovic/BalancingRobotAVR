 ...
 */
float PID::giveOutput(float input, float target, float dt, float constrainI = 0){
    float output  = 0;
...
/**
 * \breif Changes the P parameter of the regulator.
...
/**
 * \breif Changes the I parameter of the regulator.
...
/**
 * \breif Changes the D parameter of the regulator.
