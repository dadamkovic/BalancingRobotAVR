...
#define SENSOR_OK 'h'                   //< Straight from mpu6050 datasheet
...
class MPU{
    public:
        ...
        volatile float xAccAngle, yAccAngle = 0;
        volatile float xGyAngle, yGyAngle, zGyAngle = 0;
